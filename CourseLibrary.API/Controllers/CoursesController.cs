...
namespace CourseLibrary.API.Controllers
{
    ...
    public class CoursesController : ControllerBase
    {
        ...
        public ActionResult<CourseDto> GetCourseForAuthor(Guid authorId, Guid courseId)
        {
            ...
            var couseFromRepo = _courseLibraryRepository.GetCourse(authorId, courseId);

            if (couseFromRepo is null)
            {
                return NotFound();
            }

            return Ok(_mapper.Map<CourseDto>(couseFromRepo));
        }
        ...
        public IActionResult UpdateCourseForAuthor(Guid authorId, Guid courseId, CourseForUpdateDto course)
        {
            ...
            // apply the updated feild values to that dto
        ...
        [HttpDelete("{courseId}")]
        public ActionResult DeleeteCourseForAuthor(Guid authorId, Guid courseId)
        {
            if (!_courseLibraryRepository.AuthorExists(authorId))
            {
                return NotFound();
            ...
            if ( courseFromAuthorFromRepo is null)
            {
                return NotFound();
            }
